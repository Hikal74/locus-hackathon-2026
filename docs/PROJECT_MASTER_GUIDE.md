...
### Stack rationale
- **Next.js App Router** — one framework for routing, rendering, and the four server endpoints the app needs (`/api/explain`, `/api/advisor`, `/api/chat`, `/api/debureaucratize`).
